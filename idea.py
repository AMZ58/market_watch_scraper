...
def html_table_to_pandas_pickle(input, output, ticker, path, path_excel):
    for i in input:
        ...
        table.to_pickle(path + output + "_" + ticker)
        table.to_excel(path_excel + "\\" + output + "_" + ticker + ".xlsx")
...
top_market_cap = pd.read_csv(
    r"C:\Users\zuck1\PycharmProjects\pythonProject\csvoftickers_list\top25_comp_b_mcap.csv")
energy_tickers = pd.read_csv(r"C:\Users\zuck1\PycharmProjects\pythonProject\csvoftickers_list\top25Energy.csv")
financial_tickers = pd.read_csv(r"C:\Users\zuck1\PycharmProjects\pythonProject\csvoftickers_list\top25FIN.csv")
IT_tickers = pd.read_csv(r"C:\Users\zuck1\PycharmProjects\pythonProject\csvoftickers_list\top25ITcomp.csv")
real_estate_tickers = pd.read_csv(
    r"C:\Users\zuck1\PycharmProjects\pythonProject\csvoftickers_list\top25RealEstate.csv")
industrial_tickers = pd.read_csv(
    r"C:\Users\zuck1\PycharmProjects\pythonProject\csvoftickers_list\top25Industrials.csv")
...
if selection == "a":
    ...
    try:
        m_cap_path = r"C:\Users\zuck1\PycharmProjects\pythonProject" + "\\" + "Top 25 Companies - Highest Market Cap"
        os.mkdir(m_cap_path)
    ...
    try:
        energy_path = r"C:\Users\zuck1\PycharmProjects\pythonProject" + "\\" + "Top 25 Energy Companies"
    ...
    try:
        financial_path = r"C:\Users\zuck1\PycharmProjects\pythonProject" + "\\" + "Top 25 Financial Companies"
    ...
    try:
        IT_path = r"C:\Users\zuck1\PycharmProjects\pythonProject" + "\\" + "Top 25 IT Companies"
        os.mkdir(IT_path)
    ...
    try:
        RE_path = r"C:\Users\zuck1\PycharmProjects\pythonProject" + "\\" + "Top 25 Real Estate Companies"
        os.mkdir(RE_path)
    ...
    try:
        IND_path = r"C:\Users\zuck1\PycharmProjects\pythonProject" + "\\" + "Top 25 Industrial Companies"
        os.mkdir(IND_path)
